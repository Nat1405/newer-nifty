...
from nifsDefs import datefmt, listit, writeList, checkLists, writeCenters, makeSkyList, MEFarith, convertRAdec
import numpy
...
def start(
    ...
    for observationDirectory in observationDirectoryList:
        ...
        valindex = start
        if valindex > stop  or valindex < 1 or stop > 10:
