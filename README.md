...
1. Install Ureka (http://ssb.stsci.edu/ureka/) which will install the Gemini IRAF package (http://www.gemini.edu/sciops/data-and-results/processing-software).
