...
You can also run an individual step by turning them on or off in linearPipeline config and running the linearPipeline.
...
And run the linearPipeline with:
